...
// $(window).click(klikVan);
// $('#prijavadiv').outclick(function() { 
...
//     var skrolovanjeGornjaIvica = $(window).scrollTop();
//     var skrolovanjeDonjaIvica = skrolovanjeGornjaIvica+$(window).height();
//     var gore = $(div).offset().top;
//     var dole = gore + $(div).height();
//     // var gore1 = $(div1).offset().top;
//     // var dole1 = gore1 + $(div1).height();
//     // if ((dole1<=skrolovanjeDonjaIvica) && (gore1>=skrolovanjeGornjaIvica)) {
//     // $('#tekst').animate({ fontSize: "185%" }, 1000)
//     // }
//     // else{
//     //    $('#tekst').css('width', '100%')
//     // }
//     if ((dole<=skrolovanjeDonjaIvica) && (gore>=skrolovanjeGornjaIvica)) {
//     setTimeout(smanjenje, 2000)
//     }
// }); //timeout za cene za registrovane korisnike koji se smanjuje na 2s
// if($('#prijavadiv').hasClass("d-block")){

// $(document).click(function(e) {
//   // console.log(e.target.id)
//   // let kliknuto=e.target.id
//   if($('#'+kliknuto+'div').hasClass("d-block")){
// $(document).click(function(e) {
//     if (e.target.id != 'prijavadiv' && !$('#prijavadiv').find(e.target).length) {
//       console.log("uslo")
//         document.getElementById("prijavadiv").classList.toggle("d-none");
//        document.getElementById("prijavadiv").classList.toggle("d-block");
//     }
//   })
...
// }
// function smanjenje(){
// var promenljiva=document.getElementsByClassName("odbrojavanje1");
//   var promenljivaa=document.getElementsByClassName("odbrojavanje2");
//   var prvaKolona=[]
//   var drugaKolona=[]
//   for(p of promenljiva){
//     prvaKolona.push(p.getAttribute('data-value'))
//   }
//   for(pp of promenljivaa){
//     drugaKolona.push(pp.getAttribute('data-value'))
//   }
//   for(i=0;i<prvaKolona.length;i++){
//     console.log(i)
//     while(prvaKolona[i]!=drugaKolona[i]){
//       prvaKolona[i]--;
//       document.getElementById("odbrojavanje"+i).innerHTML=prvaKolona[i]+` din <i class="fa fa-percent"></i>`;
//     }
//   }
// } //funkcija za odbrojavanje cena za reg korisnike

// function klikVan(){
// if($('#prijavadiv').hasClass("d-flex")){
//   console.log("prvo")
// $('#prijavadiv').clickout(function(){
//   console.log("Sdfs")
//   document.getElementById("prijavadiv").classList.remove("d-flex")
//   document.getElementById("prijavadiv").classList.add("d-none")
// //  document.getElementById("prijavadiv").classList.toggle("d-none");
